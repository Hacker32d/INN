...
// Importación nativa de Vite para la imagen
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <section className="relative bg-slate-900 text-white py-20 px-4 text-center overflow-hidden">
        {/* Gradiente de 2 tonos limpio */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/95 to-emerald-950/85 z-10" />
        
        {/* Imagen de fondo detrás del gradiente */}
        <img
          src={headerImg}
          alt="Nosotros"
        ...
        {/* Contenido en su propia etiqueta bien separada */}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 sm:p-10 rounded-3xl border border-slate-100 shadow-sm space-y-4">
            <div className="w-14 h-14 bg-emerald-100 text-emerald-600 flex items-center justify-center rounded-2xl text-3xl font-bold">
              🎖️
            </div>
